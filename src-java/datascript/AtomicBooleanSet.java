...
public class AtomicBooleanSet implements ISortedSet {
  ...
  public AtomicBooleanSet toTransient() {
    return new AtomicBooleanSet(root, size, depth, new AtomicBoolean(true));
  }

  public AtomicBooleanSet toPersistent() {
    setEdit.setPlain(false);
    return this;
  }

  public AtomicBooleanSet with(Object key) {
